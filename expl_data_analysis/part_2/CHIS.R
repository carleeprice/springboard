...
ggplot(adult, aes (x = SRAGE_P, fill= factor(RBMI), density = "fill")) +
...
# CREATE A FACETED FREQUENCY HISTOGRAM MANUALLY
...
# REPLACE APPLY() WITH AS AS.DF.MATRIX, ALTER WIDTH OF BARS
...
# INTRODUCE CHI-SQUARE RESIDUALS TO PORTRAY OVER/UNDER REPRESENTATION
